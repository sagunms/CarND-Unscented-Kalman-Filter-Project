...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  ...
  */
  ...
  // call prediction before the update
  Prediction(delta_t);

  // call corresponding update function according to measurement sensor type
...
void UKF::Prediction(double delta_t) {
  ...
  */
  ...
  for (int i = 0; i < 2*n_aug_+1; i++) {
    ...
    // include measurement and process noise.
...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
  ...
  */
  ...
  // init matrix for sigma points in measurement space
  ...
  // include measurement noise covariance matrix
